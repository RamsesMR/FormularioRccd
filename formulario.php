                ...
                <div class="row mb-2 mb-md-3">
                     ...
                     <!-- Campo de Edad -->
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" style="border: solid 1px black;" name="menoredad" id="menoredad_si"
                                        value="si" required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" style="border: solid 1px black;" name="menoredad" id="menoredad_no"
                                        value="no" required>
                    ...
                    <div class="row mb-2 mb-md-3">
                        ...
                        <div class="row mb-2 mb-md-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">¿Percibe renta mínima de inserción? <span
                                        class="asterisk">*</span></label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" style="border: solid 1px black;" name="rminima" id="rminima_si"
                                        value="si" required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" style="border: solid 1px black;" name="rminima" id="rminima_no"
                                        value="no" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" style="border: solid 1px black;" id="boletin" name="boletin">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" style="border: solid 1px black;" id="consentimiento"
