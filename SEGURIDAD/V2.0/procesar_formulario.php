...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function crearUsuario()
    {
        ...
        return $getNombreEmail . $getApellidoEmail . "@rccd.es";
    }

    $usuario = crearUsuario();


    //consulta de base de datos para traernos informacion de los usuario y verificar que no hayan usuarios duplicados al momento de crear un usuario
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            if ($fila["usuario"] == $usuario) {
                ...
                while (true) {
                    ...
                    $usuarioSinDominio = str_replace("@rccd.es", "", $usuario);
                    ...
                    $usuarioNuevo = $usuarioSinDominio . "@rccd.es";
    ...
    $sql = "INSERT INTO `alumnos`(`email`, `tipo_identidad`,`numero_documento`, `centro_formacion`, `nombre`, `apellidos`, `telefono`, `localidad`, `sexo`, `fecha_nacimiento`, `estudios`, `situacion_laboral`, `conocido` ,`renta_minima`, `notificaciones_email`,`consentimiento`, `fecha_registro`,`usuario`) VALUES (
        '$email', '$tipoDocumento', '$numeroDocumento', '$centro', '$nombre', '$apellidos', '$telefono', '$localidad', '$sexo', 
        '$fnacimiento', '$estudios', '$slaboral', '$comoconocido','$renta','$notificacionCorreo','$consentimiento','$fechaRegistro','$usuario' )";
